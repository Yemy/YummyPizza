...
$sql="update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,BookPrice=:price,nofbooks=:noofbooks where id=:bookid";
...
<head>
    ...
    <title>Defence University Collage of Engineering Library Management System| Edit Book</title>
...
<p class="help-block">ISBN Must be unique</p>
 ...
 <input class="form-control" type="text" name="price" value="<?php echo htmlentities($result->BookPrice);?>"   required="required" />
  ...
  <div class="form-group">
 <label>#Books in Hand<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="noofbooks" value="<?php echo htmlentities($result->nofbooks);?>"   required="required" />
 </div>
 <?php }} ?>
