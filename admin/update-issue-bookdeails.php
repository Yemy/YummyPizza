...
$fine=$_POST['fine'];
// $finepday = 1;
// $currentdate = date("j of F Y, \a\\t g.i a", time());
// $fine = ($currentdate - $IssuesDate)* $finepday;
...
<head>
    ...
    <title>Defence University Collage of Engineering Library Management System| Issued Book Details</title>
